...
/**
 * <p>Title: OldShorthandCompiler</p>
...
public class OldShorthandCompiler { //implements RemovalListener<String, ShorthandStaticInterceptor> {
//	/** The singleton instance */	
//	private static volatile OldShorthandCompiler instance = null;
...
//	 */
//	public static final OldShorthandCompiler getInstance() {
//		if(instance==null) {
//			synchronized(lock) {
//				if(instance==null) {
//					instance = new OldShorthandCompiler();
//				}
//			}
//		}
//		return instance;
...
//		log("OldShorthandCompiler");
//		ManagementFactory.getThreadMXBean().setThreadContentionMonitoringEnabled(true);
//		ManagementFactory.getThreadMXBean().setThreadCpuTimeEnabled(true);
//		OldShorthandCompiler compiler = OldShorthandCompiler.getInstance();
//		try {
