 ...
 * <p><code>com.heliosapm.opentsdb.client.opentsdb.OpenTsdbPutResponseHandler.PutResponseHandler</code></p>
 */
public interface PutResponseHandler {
	/**
	 * Processes a put response
